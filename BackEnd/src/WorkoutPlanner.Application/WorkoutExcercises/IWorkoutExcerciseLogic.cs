...
{
    public WorkoutExcercise createWorkoutExcercise(string name, Guid workoutId, Guid excerciseId, int reps, int sets, Enums.LoadType loadType, int? weight = null, int? percentage = null);
